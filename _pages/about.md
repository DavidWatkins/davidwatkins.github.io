---
permalink: /
title: "David Watkins - Research Lead"
excerpt: "About me"
author_profile: true
redirect_from:
  - /about/
...
I'm a **Research Lead** at [Tutor Intelligence](https://tutorintelligence.com/), where I work on foundation model research and training for robot manipulation. I also advise [Tola Capital](https://www.tola.vc/) on robotics and AI investments. Previously I was a **Research Lead** at the [RAI Institute](https://theaiinstitute.com/) (formerly Boston Dynamics AI Institute), where I built foundation models and large-scale data infrastructure for learning; I joined as the 18th employee and helped grow the organization to over 275 people.
...
- Founded and lead the **Capture** team (30 people), the largest data collection effort at the institute with a roadmap for **100,000+ demonstrations**
...
- Developed [DIP-RL](https://arxiv.org/abs/2307.12158), a preference-based RL algorithm that leverages demonstrations to infer reward functions from human preferences (ICML 2023)
...
- Co-authoring [**"Elephants Don't Write Sonnets"**]({{ base_url }}/publication/2025-08-06-elephants-dont-write-sonnets) with [Stefanie Tellex](https://cs.brown.edu/people/stellex/) (MIT Press 2026) on the Grounded Turing Test for embodied AI
